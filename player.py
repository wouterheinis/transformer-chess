...
Original file is located at
    https://colab.research.google.com/drive/1dELzLJvIbgELq4HhoOh-El9Mj4vRNIxN
"""
...
from chess_tournament import RandomPlayer, Game

#engine_strong = EnginePlayer("Stockfish-Strong", blunder_rate=0.0, ponder_rate=0.5)
#engine_weak = EnginePlayer("Stockfish-Weak", blunder_rate=0.25, ponder_rate=0.65)
r = RandomPlayer("Random")
p = TransformerPlayer("Wouter-v2")

game = Game(p, r, max_half_moves=200)
